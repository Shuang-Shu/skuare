  ...
  },
  {
    ...
    help: {
      ...
      details: [
        ...
        "Default target: walk upward from cwd to the nearest workspace root containing .skuare, then install into <workspace>/.{tool}/skills/",
        "If upward lookup only reaches ~/.skuare, run `skr init` in your project directory first; use --global to install into ~/.{tool}/skills/",
